{{-- Mismo criterio que mail/reset-password.blade.php: el logo va incrustado
...
<x-mail-layout :logo-url="$logoCid">
  ...
  <p style="margin:0 0 28px 0; color:#667085; font-size:14.5px; line-height:1.65; text-align:center;">
    Pediste cambiar el correo de tu cuenta en <strong style="color:#344054;">{{ config('app.name') }}</strong> a esta dirección. Tocá el botón para confirmarlo — hasta entonces, tu correo actual sigue siendo el que usás para iniciar sesión.
  </p>
    ...
    <tr>
      <td style="padding:14px 16px; background-color:#fafafa; border:1px solid #eef0f4; border-radius:10px; text-align:center;">
        <p style="margin:0; color:#98a2b3; font-size:12.5px; line-height:1.6;">
          ⏱ Este enlace expira en <strong style="color:#667085;">60 minutos</strong>. Si no pediste este cambio, ignorá este correo — tu cuenta sigue igual.
        </p>
      </td>
    </tr>
  </table>
